...
<html lang="en">
    <head>
        ...
        <title>Barang Masuk - Sistem Informasi Gudang Obat</title>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index.php">
                                <div class="sb-nav-link-icon" href=""><i class="fas fa-tachometer-alt"></i></div>
                                Stock Barang
                            </a>
                            <a class="nav-link" href="index.php">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Barang/obat yang masuk ke gudang</li>
                        </ol>
                        <div class="card mb-4">
